	...
	return this.each(function() {
		...
		*/
		...
		function circularNav() {
			...
			jQuery(settings.navContainer).append('<div class="simpleSliderNav">' + itemNav + '</div>');
		}
		//Get slides
		...
		if(settings.wantNav) {
			...
			var sliderNavButtons = jQuery(settings.navContainer).find('.simpleSliderNav').children();
