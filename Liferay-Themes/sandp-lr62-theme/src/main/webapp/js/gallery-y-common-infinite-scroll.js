    ...
    _processResponse: function(response) {
        ...
        if (response.length > 0) {
            ...
            Y.Array.each(response, function (item) {
                ...
                $(div).append(Y.Lang.sub(me.get('itemTemplate'), item));
            ...
            $('#masonry_container').masonry({
				   itemSelector : '.item',
				   columnWidth : 3
			}).append( fragment ).masonry( 'appended', elems);
...
//                                item = me.get('itemPreProcessor')(item);
//                                //me.get('container').append(Y.Lang.sub(me.get('itemTemplate'), item));
//                                alert(Y.Lang.sub(me.get('itemTemplate'), item));
//                            });
//                        } 
//                         alert(items+"item in call back");
//                    }
//          });          
//          
        requestCustomData: {
