...
/*
  if ($('#main-rotor #login .portlet-login .portlet-title .portlet-title-text').text() != 'Forgot Password') {
    ...
    //console.log($('#main-rotor #login .portlet-login .aui-field-input').filter(':first'));
    //$('#main-rotor #login .portlet-login .aui-field-input-text:first').attr('placeholder', 'Your NetSpace User Name');
  }
